...
##  sim_metric:
##      Description- The method used to assign a similarity score to a SCU component and a candidate substring
##      Format- One of the following: "uni", "ro", "cos"
##  combine:
##      Description- The method used to select one of the similarity scores assigned to a candidate substring
##                  and the components of a SCU
##      Format- One of the following: "min", "mean", "max"
##  threshold:
##      Description- The similarity score above which a candidate substring is considered to match a SCU
##      Format- A percentage expressed as a decimal rounded to the hundredth position
